...
mysqli_select_db($website,$database_website );
$query_cat = "SELECT * FROM prep_university ";
...
$id_field='prep_university_id';
$main_page_link='admin/system/prep_university/';

/// dont change this ////
$id=$_GET['id'];

$view_table='SELECT * FROM '.$table.'  ORDER BY '.$id_field.' DESC';
...
prep_university_name_ar="'.$_POST['title'].'",
prep_university_desc_ar="'.$_POST['desc'].'"
WHERE '.$id_field.'="'.$id.'"';


//// english update ////
$update_en='UPDATE '.$table.' SET
prep_university_name_en="'.$_POST['title'].'",
prep_university_desc_en="'.$_POST['desc'].'"
WHERE '.$id_field.'="'.$id.'"';
...
(prep_university_name_ar , prep_university_desc_ar, prep_university_thumb)
VALUES
(
"'.$_POST['title'].'",
"'.$_POST['desc'].'",
...
(prep_university_name_en , prep_university_desc_en,   prep_university_thumb )
VALUES
(
"'.$_POST['title'].'",
"'.$_POST['desc'].'",
  			...
  			?>
				...
				<section class="<?php echo $pageHeaderStyle; ?>" style="background-image: url(&quot;../../images/google.png&quot;); background-position: 100% 0px;" >
							...
							<div class="container <?php if($_SESSION['language']=='AR') { ?>  text-right <?php } ?>">
								...
								<h1 style="font-family: 'Cairo', sans-serif;"><?php echo $vPreparationProgram; ?></h1>

								<!-- breadcrumbs -->
								<ol class="breadcrumb">
									<li><a href="<?php echo $server; ?><?php echo $main_page_link; ?>" style="font-family: 'Cairo', sans-serif;"><?php echo $vPreparationProgram ; ?></a></li>
								...
								<div class="box-title mb-10" >
									...
									<fieldset style="padding: 0px">
										...
										<div class="row">
											...
											<div class="col-md-12 col-sm-12">
												<label><?php echo $vDescription ; ?> *</label>
												<label class="input mb-10">
													<i class="ico-append fa fa-user"></i>
													
													
													
													<textarea style="font-family: 'Cairo', sans-serif;" name="desc" rows="5" class="form-control word-count" data-maxlength="200" data-info="textarea-words-info" placeholder="<?php echo $vDescription ; ?>..."></textarea>
													
													
													<b class="tooltip tooltip-bottom-right"><?php echo $vDescription ; ?></b>
												</label>
											</div>
										...
										<div class="row">
											...
											<div class="col-md-12 col-sm-12">
												...
												<label class="input mb-10">
													...
													if($_SESSION['language']=='EN') 
													{
													echo $row_articles2['prep_university_name_en']; 
													}
	
													if($_SESSION['language']=='AR') 
													{
													echo $row_articles2['prep_university_name_ar']; 
													}
													?>">
													<b class="tooltip tooltip-bottom-right"><?php echo $vTitle ; ?></b>
												</label>
										...
										<div class="row">
											...
											<div class="col-md-12 col-sm-12">
												...
												<label class="input mb-10">
													...
													<textarea style="font-family: 'Cairo', sans-serif;" name="desc" rows="5" class="form-control word-count" data-maxlength="200" data-info="textarea-words-info" placeholder="<?php echo $vDescription ; ?>...">
													
													<?php 
													if($_SESSION['language']=='EN') 
													{
													echo $row_articles2['prep_university_desc_en']; 
													}
	
													if($_SESSION['language']=='AR') 
													{
													echo $row_articles2['prep_university_desc_ar']; 
													}
													?>
...
if ((isset($_POST["title2"])) && ($_POST["title2"] <> "")) {
	...
	$sql = "UPDATE prep_university SET prep_university_thumb='".$image_name."' WHERE prep_university_id='".$_POST["id"]."'";
...
<div class="table-responsive" style="margin-top: 0px">
						...
						<table class="<?php echo $tableStyle; ?>" style="font-family: 'Cairo', sans-serif;">
							...
							<tbody>
								<?php do { 
								if(isset($row_articles['prep_university_id'])) {
								?>
								<tr>
									...
									<td style="padding-top: 0px; padding-bottom: 0px">
										<ul class="list-inline nomargin size-12 <?php if($_SESSION['language']=='EN') { ?> text-right <?php } else  { ?> text-left<?php } ?>">
											...
											<li><a style="color: dodgerblue" href="?edit=1&id=<?php echo $row_articles['prep_university_id']; ?>" class="fa fa-edit  margin-top-6  " data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo $vEdit; ?>"></a></li>


											<li><a style="color: dodgerblue" href="?update_thumb=1&id=<?php echo $row_articles['prep_university_id']; ?>" class="fa fa-image   margin-top-6" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo $vUpdateThumb; ?>"></a></li>

											
											
											<?php if(isset($row_articles['prep_university_thumb']) && $row_articles['prep_university_thumb']<>"") { ?>
											<li><a  style="color: dodgerblue" target="_blank" href="../../uploads/images/<?php echo $row_articles['prep_university_thumb']; ?>" class="fa fa-eye  margin-top-6 " data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo $vPhoto; ?>"></a></li>
											<?php } ?>
											
											&nbsp &nbsp 
											
											<li><a onclick="return confirm('<?php echo $vDeleteMessage; ?>')" style="color: darkred" href="?delete=1&id=<?php echo $row_articles['prep_university_id']; ?>" class="fa fa-trash  margin-top-6 " data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo $vDelete; ?>"></a></li>
