...
<html lang="en">
	...
	<body class="<?php echo $bodyClass; ?>" data-background="<?php echo $server; ?>control_panel/<?php echo $bgForBoxed; ?>">
		...
		<div id="wrapper">
			...
			<!-- REVOLUTION SLIDER -->
		<section class="page-header page-header-xlg parallaxsx-3 <?php if($_SESSION['language']=='AR') {  ?> text-right <?php } ?>" style="background-image: url(&quot;../../images/study_banner.jpg&quot;);  ">
				<div class="overlay dark-5"><!-- dark overlay [1 to 9 opacity] --></div>

				<div class="container">

					<h1 style="font-family: 'Cairo', sans-serif; color: white"><?php echo $vWhyStudyInRussia; ?></h1>
