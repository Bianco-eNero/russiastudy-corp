...
mysqli_select_db($website,$database_website );
$query_cat = "SELECT * FROM university ";
...
$main_page_link='admin/system/university/';
...
university_name_ar="'.$_POST['title'].'"
WHERE '.$id_field.'="'.$id.'"';


//// english update ////
$update_en='UPDATE '.$table.' SET
university_name_en="'.$_POST['title'].'"
WHERE '.$id_field.'="'.$id.'"';
...
(university_name_ar ,  university_thumb)
VALUES
(
"'.$_POST['title'].'",
"'.$image_name.'"
...
(university_name_en ,  university_thumb )
VALUES
(
"'.$_POST['title'].'",
"'.$image_name.'"
										...
										<div class="row">
											...
											<div class="col-md-12 col-sm-12">
												...
												<label class="input mb-10">
													...
													if($_SESSION['language']=='EN') 
													{
													echo $row_articles2['university_name_en']; 
													}
	
													if($_SESSION['language']=='AR') 
													{
													echo $row_articles2['university_name_ar']; 
													}
													?>">
													<b class="tooltip tooltip-bottom-right"><?php echo $vTitle ; ?></b>
												</label>
...
if ((isset($_POST["title2"])) && ($_POST["title2"] <> "")) {
	...
	$sql = "UPDATE university SET university_thumb='".$image_name."' WHERE university_id='".$_POST["id"]."'";
...
<div class="table-responsive" style="margin-top: 0px">
						...
						<table class="<?php echo $tableStyle; ?>" style="font-family: 'Cairo', sans-serif;">
							...
							<tbody>
								<?php do { 
								if(isset($row_articles['university_id'])) {
								?>
								<tr>
									...
									<td style="padding-top: 0px; padding-bottom: 0px"><?php 
										if($_SESSION['language']=='EN')
										{
										echo $row_articles['university_name_en']; 
										}
										 
										if($_SESSION['language']=='AR')
										{
										echo $row_articles['university_name_ar']; 
										}
										?>
									</td>
									...
									<td style="padding-top: 0px; padding-bottom: 0px">
										<ul class="list-inline nomargin size-12 <?php if($_SESSION['language']=='EN') { ?> text-right <?php } else  { ?> text-left<?php } ?>">
											...
											<li><a style="color: dodgerblue" href="?edit=1&id=<?php echo $row_articles['university_id']; ?>" class="fa fa-edit  margin-top-6  " data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo $vEdit; ?>"></a></li>


											<li><a style="color: dodgerblue" href="?update_thumb=1&id=<?php echo $row_articles['university_id']; ?>" class="fa fa-image   margin-top-6" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo $vUpdateThumb; ?>"></a></li>

											
											
											<?php if(isset($row_articles['university_thumb']) && $row_articles['university_thumb']<>"") { ?>
											<li><a  style="color: dodgerblue" target="_blank" href="../../uploads/images/<?php echo $row_articles['university_thumb']; ?>" class="fa fa-eye  margin-top-6 " data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo $vPhoto; ?>"></a></li>
											<?php } ?>
											
											&nbsp &nbsp 
											
											<li><a onclick="return confirm('<?php echo $vDeleteMessage; ?>')" style="color: darkred" href="?delete=1&id=<?php echo $row_articles['university_id']; ?>" class="fa fa-trash  margin-top-6 " data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo $vDelete; ?>"></a></li>
