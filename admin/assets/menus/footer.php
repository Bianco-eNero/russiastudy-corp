<footer id="footer" class="footer-light">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <!-- Footer Logo -->
        <img class="footer-logo" src="<?php echo $server; ?>admin/assets/smarty_files/assets/images/_smarty/logo-footer-1.png" alt="" />
...
s1.async=true;
s1.src='https://embed.tawk.to/5801f6fea4209520468754ae/default';
s1.charset='UTF-8';
