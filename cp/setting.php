<?php 
define('CNF_APPNAME','Sximo 5 - DataTable CRUD');
define('CNF_APPDESC','CRUD BUILDER');
define('CNF_COMNAME','Company Name');
...
define('CNF_THEME','bootstrap');
define('CNF_MULTILANG','true');
define('CNF_CICAPTCHA','');
