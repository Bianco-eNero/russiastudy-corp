		<div class="sbox-tools pull-left">
				...
				<?php if($this->access['is_add'] ==1) : ?>
					...
					<a href="javascript:void(0)" class=" tips btn btn-default btn-xs Action_Row" title="<?php echo $this->lang->line('core.btn_copy'); ?>" code="copy"><i class="fa fa-copy"></i> </a>
				<?php endif;
    	...
    	<div class="sbox-tools pull-right ">
				...
				<a href="<?php echo site_url('sximo/module/config/notification') ?>" class="tips btn btn-xs btn-default"  title="<?php echo $this->lang->line('core.btn_config'); ?>">
