...
<div class="sbox animated fadeInRight">
	<div class="sbox-title"><h4> Form Grid  </h4></div>
	...
	<ul class="nav nav-tabs" style="margin-bottom:10px;">
		...
		<li ><a href="<?php echo site_url('sximo/module/subform/'.$module_name);?>">Sub Form</a></li> 
 ...
 <div class="table-responsive">
		...
		<thead class="no-border">
          <tr >
            ...
            <th scope="col" data-hide="phone"><?php echo $this->lang->line('core.mod_thsearchable'); ?> <br /><input type="checkbox" class="checkallView" /></th>
          ...
          <tr>
            ...
            <td>
			<label >
            <input type="checkbox" name="view[<?php echo $id;?>]" value="1" class="cShow"
            ...
            <td>
			<label >
            <input type="checkbox" name="search[<?php echo $id;?>]" value="1"  class="cView"
