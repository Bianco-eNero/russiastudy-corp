		...
		<div class="sbox">
			...
			<div class="sbox-title">
				...
				<div  class="sbox-tools ">
					<a href="<?php echo site_url('sximo/tables/tableConfig/') ?>" class="btn btn-sm btn-default linkConfig"><i class="fa fa-plus"></i> New Table </a>
					<a href="<?php echo site_url('sximo/tables/mysqlEditor/') ?>" class="btn btn-sm btn-default linkConfig"><i class="fa fa-pencil"></i> MySQL Editor </a>
				</div>
			</div>
				  				...
				  				<table class="table table-striped">
				  					...
				  					<?php foreach($tables as $table): ?>   	  			
				  						<tr>
											...
											<td>
												<a href="javascript:void(0)" onclick="droptable()" class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
											</td>
				  						</tr>
				  					<?php endforeach; ?>
				  					</tbody>
