...
<div class="page-content row">
    ...
    <div class="page-content-wrapper m-t">
		...
		<div id="pagesView"></div>			
		<div id="pagesGrid">

<div class="sbox"  >
	<div class="sbox-title" >  
	<?php $this->load->view('sximo/pages/toolbar');?>
	</div>
	<div class="sbox-content" style="min-height: 500px;">
			

			<div class="table-responsive">
			<table id="pagesTable" class="table table-striped table-bordered table-hover display" cellspacing="0" width="100%">
		        <thead>
		            <tr>
		            <th>ID</th>	
	...
	$(document).ready(function() {
		...
		var rows_selected = []; 			
	   	var table = $('#pagesTable').DataTable( {
	        ...
	        "ajax": {
	            "url": "<?php echo site_url('sximo/pages/data');?>",
	            "type": "POST"
        	},
        	"columnDefs": [{ 
        		"targets": [0],
		...
		$('#pagesTable tbody').on('click', 'td.details-control', function () {
	        ...
	        if ( row.child.isShown() ) {
	            ...
	            tr.addClass('shown');
	            $.get('<?php echo site_url("sximo/pages/show") ;?>/'+id , function(callback){
	            	$('#'+id).html(callback);
	            	$('#'+id).addClass('data');
	            })
	    ...
	    $('#pagesTable').Sdtable({
	    	tableId : '#pages',
	    	table   : table,
	    	action  : '<?php echo site_url("sximo/pages");?>' 
	    });
