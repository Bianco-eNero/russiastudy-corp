...
class Config extends SB_Controller  {
  ...
  public function postSave()
  {
      ...
      if(isset($_FILES['logo']))
      {
          ...
          if(move_uploaded_file($_FILES['logo']['tmp_name'],'sximo/images/backend-logo.'.$ext))
          {
               $logo = 'backend-logo.'.$ext;
          } 
      ...
      $val .=   "define('CNF_DATE','".(!is_null($this->input->post('cnf_date')) ? $this->input->post('cnf_date') : 'Y-m-d' )."');\n";
      $val .=   "define('CNF_LOGO','".$logo."');\n";
      $val .=   "?>";
  ...
  function postSecurity() {
      ...
      $val .=   "define('CNF_LOGO','".(defined('CNF_LOGO') ? CNF_LOGO : 'backend-logo.png') ."');\n";
      $val .=   "?>";
