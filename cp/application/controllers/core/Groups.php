...
class Groups extends SB_Controller 
{
	...
	function __construct() {
		...
		$this->load->model('core/groupsmodel');
	...
	public function index()
	{
		...
		$this->data['content'] = $this->load->view('core/groups/index',$this->data, true );		
	...
	function show( $id = null) 
	{
		...
		if($row)
		{
			...
			$this->data['row'] = $this->model->getColumnTable('groups'); 
		}
		...
		$this->data['setting'] 		= $this->info['setting'];
		$this->data['access']		= $this->access;
		$this->load->view('core/groups/view', $this->data);	  
	}
	...
	function update( $id = null ) 
	{
		...
		$this->data['id'] = $id;
		$this->data['setting'] 		= $this->info['setting'];
		$this->load->view('core/groups/form',$this->data);		
	...
	function save() {
		...
		if( $this->form_validation->run() )
		{
			...
			$ID = $this->model->insertRow($data , $this->input->get_post( 'group_id'));
