...
class Notification extends SB_Controller 
{
	...
	function __construct() {
		...
		$this->load->model('core/notificationmodel');
	...
	public function index()
	{
		...
		$this->data['content'] = $this->load->view('core/notification/index',$this->data, true );		
	...
	function show( $id = null) 
	{
		...
		if($row)
		{
			...
			$this->data['row'] = $this->model->getColumnTable('notification'); 
		}
		...
		$this->data['setting'] 		= $this->info['setting'];
		$this->data['access']		= $this->access;
		$this->load->view('core/notification/view', $this->data);	  
	}
	...
	function update( $id = null ) 
	{
		...
		$this->data['id'] = $id;
		$this->data['setting'] 		= $this->info['setting'];
		$this->load->view('notification/form',$this->data);		
