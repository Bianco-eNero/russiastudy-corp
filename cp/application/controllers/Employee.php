...
class Employee extends SB_Controller 
{
	...
	public function index()
	{
		...
		$this->data['content'] = $this->load->view('employee/index',$this->data, true );		
	...
	function show( $id = null) 
	{
		...
		if($row)
		{
			...
			if($print =='true')
			{
				$data['html'] =  $this->load->view('employee/view', $this->data ,true);
				$this->load->view('layouts/blank',$data);
			} else {
				$this->load->view('employee/view', $this->data);
			}
		} else {
	...
	function save() {
		...
		if( $this->form_validation->run() )
		{
			...
			$ID = $this->model->insertRow($data , $this->input->get_post( 'employee_id' , true ));
			
			// Input logs
			if( $this->input->get( 'employee_id' , true ) =='')
			{
